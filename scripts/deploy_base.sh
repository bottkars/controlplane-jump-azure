...
CONTROLPLANE_DOMAIN_NAME=$(get_setting CONTROLPLANE_DOMAIN_NAME)
CONTROLPLANE_SUBDOMAIN_NAME=$(get_setting CONTROLPLANE_SUBDOMAIN_NAME)
OPSMAN_USERNAME=$(get_setting OPSMAN_USERNAME)
CONTROLPLANE_NOTIFICATIONS_EMAIL=$(get_setting CONTROLPLANE_NOTIFICATIONS_EMAIL)
CONTROLPLANE_AUTOPILOT=$(get_setting CONTROLPLANE_AUTOPILOT)
...
LOCATION="${LOCATION}"
CONTROLPLANE_DOMAIN_NAME="${CONTROLPLANE_DOMAIN_NAME}"
CONTROLPLANE_SUBDOMAIN_NAME="${CONTROLPLANE_SUBDOMAIN_NAME}"
HOME_DIR="${HOME_DIR}"
OPSMAN_USERNAME="${OPSMAN_USERNAME}"
CONTROLPLANE_NOTIFICATIONS_EMAIL="${CONTROLPLANE_NOTIFICATIONS_EMAIL}"
CONTROLPLANE_AUTOPILOT="${CONTROLPLANE_AUTOPILOT}"
